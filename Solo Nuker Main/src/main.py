...
def main():
    ...
    # Set Console title
    set_console_title("Solo V1 | Made by 2larp | Menu")
    ...
    banner = """
                        ...
                        ╔═════════════════════════╗      ╔═════════════════════════╗
                        ║       dsc.gg/MHsMkbDk   ║      ║        dsc.gg/MHsMkbDk  ║
                     ╔═══════════════════════════════╗   ╔═══════════════════════════════╗
    ...
    info = f"""{Fore.LIGHTCYAN_EX}\t\t\t\t\t  [+] Made by 2larp [+]"""
    for x in info:
        time.sleep(0.0001)
        sys.stdout.write(x)
        sys.stdout.flush()
...
def socials():
    ...
    # Set Console title
    set_console_title("Solo V1 | Made by 2larp | Socials")
